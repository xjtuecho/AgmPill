...
set verilogs { E:\\echo\\project\\echo\\Company\\AGM\\Blink_EP4CE10\\common\\DFFx2.v E:\\echo\\project\\echo\\Company\\AGM\\Blink_EP4CE10\\common\\clkdivider.v E:\\echo\\project\\echo\\Company\\AGM\\Blink_EP4CE10\\ipcore_dir\\PLL.v E:\\echo\\project\\echo\\Company\\AGM\\Blink_EP4CE10\\Blink.v }
if { [ llength $verilogs ] == 0 } {
  set verilogs "E:/echo/project/echo/Company/AGM/Blink_EP4CE10/${DESIGN}.v"
}
