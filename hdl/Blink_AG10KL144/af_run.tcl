...
set ORIGINAL_QSF "E:/echo/project/echo/Company/AGM/Blink_EP4CE10/./Blink.qsf"
set ORIGINAL_PIN "E:/echo/project/echo/Company/AGM/Blink_EP4CE10/out/Blink.pin"
...
if { $LOAD_DB } {
  ...
  if { ! [file exists $verilog] } {
    set verilog "E:/echo/project/echo/Company/AGM/Blink_EP4CE10/simulation/modelsim/${DESIGN}.vo"
