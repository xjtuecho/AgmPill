...
set ORIGINAL_QSF "E:/echo/git/github/xjtuecho/AgmPill/hdl/Blink_EP4CE10/./Blink.qsf"
set ORIGINAL_PIN "E:/echo/git/github/xjtuecho/AgmPill/hdl/Blink_EP4CE10/out/Blink.pin"
...
if { $LOAD_DB } {
  ...
  if { ! [file exists $verilog] } {
    set verilog "E:/echo/git/github/xjtuecho/AgmPill/hdl/Blink_EP4CE10/simulation/modelsim/${DESIGN}.vo"
